...
echo -en '"docker run -u <username_to_run_container_as> --name jenkins --rm -p 8080:8080 -v /home/<USERNAME_HERE>:/var/jenkins_home --env JENKINS_ADMIN_ID=admin --env JENKINS_ADMIN_PASSWORD=password jenkins:jcasc"\n\n'
